...
class AssistantController {
    ...
    AssistantController(McpSyncClient  scheduler,
                        DogRepository dogRepository, VectorStore vectorStore,
                        QuestionAnswerAdvisor qa, PromptChatMemoryAdvisor promptChatMemoryAdvisor, ChatClient.Builder ai) {
...
//                .defaultTools(scheduler)
                ...
                .defaultAdvisors(promptChatMemoryAdvisor, qa)
                .defaultSystem("""
